export default function Resume () {
    return (
        <section className="pt-8 px-12 bg-[#142f54] text-white min-h-[80vh]">
            ...
            <p className="mb-4">Download my <a className="text-gray-500 font-semibold" href="https://www.dropbox.com/scl/fi/ycwwjo3dckgiqvi3z1byd/Tahnoshie-Latin.pdf?rlkey=4t5e9qg48osl7yr8vzgabvc8d&e=1&st=gqm07vt9&dl=0" target="_blank">resume</a></p>
